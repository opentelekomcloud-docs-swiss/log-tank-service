...
For details about how to enable CTS, see `Enabling CTS <https://docs.sc.otc.t-systems.com/cloud-trace-service/umn/getting_started/overview.html#>`__.

After CTS is enabled, you can view LTS-related traces. For details, see `Querying Real-Time Traces <https://docs.sc.otc.t-systems.com/cloud-trace-service/umn/traces/querying_real-time_traces.html#>`__.
