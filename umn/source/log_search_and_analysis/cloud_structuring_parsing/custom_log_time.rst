...
When logs are ingested to LTS, you can enable **Custom Log Time** to use the time field in the logs as the ingested configuration time.
...
#. Click the log stream name to go to the log stream details page. Click |image1| in the upper right corner. On the page displayed, select **Cloud Structuring Parsing** to structure logs.
#. After the configuration is complete, enable **Custom Log Time** |image2| and specify the following parameters.
   ...
   .. note::
      ...
      A time deviation may occur around the time when you enable or disable **User-defined log time** on the log search page. Do not frequently enable or disable it.
...
.. table:: **Table 2** Time formats
   ...
   +--------------------------+----------------------------------------------------------------------------------------------------------------------------------+--------------------------+
   | d                        | Number of the day in a month, decimal, ranging from 1 to 31.                                                                     | 7, 31                    |
   |                          |                                                                                                                                  |                          |
...
The following table lists common time standards, examples, and expressions.
...
.. |image1| image:: /_static/images/en-us_image_0000001481990428.png
.. |image2| image:: /_static/images/en-us_image_0000001533269109.png
