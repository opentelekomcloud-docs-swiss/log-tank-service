...
#. In the **Basic Information** step, click **Next**.

#. In the **Configure Transfer** step, configure parameters related to transfer logs to OBS, enable **Transfer to LTS**, and click **Next**.
