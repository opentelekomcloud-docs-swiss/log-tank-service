...
#. Log in to the LTS console, choose **Configuration Center** in the navigation pane on the left, and click the **ICAgent Collection** tab.
#. Enable or disable **ICAgent Collection**.
