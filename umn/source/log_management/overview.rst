...
The **Log Management** page displays information such as resource statistics, along with the **My Favorites**, **My Favorites(Local Cache)**, and **Recently Visited** lists.

Resource Statistics
-------------------

This area shows the read/write traffic, index traffic, log volume, and raw log traffic of your account on the previous day, as well as the day-over-day changes.
